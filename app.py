...
account_options = existing_accounts + ["➕ Add new account"]
...
# UPLOAD
# ===============================================================
st.markdown('<div class="section-title">📊 My Trading Journal</div>', unsafe_allow_html=True)
...
with st.expander("📥 Upload Report", expanded=False):
    uploaded = st.file_uploader("Upload your MT5 Trade History Report (.xlsx)", type=["xlsx"])
