...
# ===============================================================
# AI TRADING COACH (analyzes ALL your trades)
# ===============================================================
...
try:
    ...
    model = genai.GenerativeModel(
        "gemini-1.5-flash",
        system_instruction=(
            "You are an expert trading coach and data analyst. "
            "You will be given a trader's complete trade history as CSV data. "
            "Analyze it carefully and answer the trader's questions with specific, "
            "data-backed insights. Always cite actual numbers and trades. "
            "Be direct, honest, and action-oriented. If you see a pattern in the "
            "notes, quote it. If a specific trade is relevant, reference its position_id."
        ),
    )
except Exception as e:
    st.error(f"Could not configure AI model. Check your GEMINI_API_KEY. Error: {e}")
    st.stop()


# Build a compact CSV of ALL trades for the selected account
ai_data = filtered[[
...
# Show a stats summary at the top
...
- If session/strategy columns are filled, use them.
